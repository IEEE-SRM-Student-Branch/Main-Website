...
const Gallery = () => {
    ...
    return (
        <div className="bg-primarybg text-white w-full h-[1000px] flex flex-row max-lg:flex-col">
            <div id="galleryHeader" className="flex flex-col align-middle my-5 lg:mx-24 mx-12 w-1/3 max-lg:w-4/5">
                <h1 className="font-sans font-bold my-3 max-lg:my-5 text-4xl lg:text-5xl/[60px] sm:text-4xl">
                    Our Gallery
                </h1>
            ...
            >
                <div id="carousel"
                     className={`flex lg:flex-col max-lg:items-center lg:animate-infiniteScroll max-lg:animate-infiniteScrollMobile lg:h-[calc(360px * ${leftLength * 2})] max-lg:h-[300px] max-lg:w-[calc(360px * ${leftLength * 2})] max-ml:h-[200px] mx-5`}
                     style={{'--leftLength': leftLength}}
                >
                    {imagesLeft.map((image) => (
                        <div id="slide" className="flex justify-center lg:my-[20px] max-lg:mx-[20px] max-lg:w-[300px] max-lg:h-[300px] max-ml:w-[200px] max-ml:h-[200px]">
                            <Image
                                key={image.id}
                                src={image.src}
                                alt={image.alt}
            ...
            <div id="carousel-container"
                ...
                <div id="carousel"
                     className={`flex lg:flex-col max-lg:items-center lg:animate-infiniteScrollReverse max-lg:animate-infiniteScrollReverseMobile lg:h-[calc(360px * ${rightLength * 2})] max-lg:h-[300px] max-lg:w-[calc(360px * ${rightLength * 2})] max-ml:h-[200px] mx-5`}
                     style={{'--rightLength': rightLength}}
                >
                    {imagesRight.map((image) => (
                        <div id="slide" className="flex justify-center lg:my-[20px] max-lg:mx-[20px] max-lg:w-[300px] max-lg:h-[300px] max-ml:w-[200px] max-ml:h-[200px]">
